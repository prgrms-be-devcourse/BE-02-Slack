  ...
  class DescribeCheckMemberName {
    ...
    class ContextNullIdArgument {
      ...
      void itTrowIllegalArgumentException() {
        ...
        Assertions.assertThatThrownBy(
                () -> memberService.isDuplicateMemberName(null, channelName))
            .isInstanceOf(IllegalArgumentException.class);
      }
    }
    ...
    class ContextNullEmptyNameArgument {
      ...
      void itTrowIllegalArgumentException(String channelName) {
        ...
        //then
        Assertions.assertThatThrownBy(
                () -> memberService.isDuplicateMemberName(validWorkspaceId, channelName))
            .isInstanceOf(IllegalArgumentException.class);
      }
    }
    ...
    class ContextValidArgument {
      ...
      void itReturnFalse() {
        ...
        final boolean expected =
            memberService.isDuplicateMemberName(validWorkspaceId, validChannelName);
