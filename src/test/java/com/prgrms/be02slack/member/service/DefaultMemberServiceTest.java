  ...
  class DescribeCheckMemberName {
    ...
    class ContextNullIdArgument {
      ...
      void itTrowIllegalArgumentException() {
        ...
        Assertions.assertThatThrownBy(
                () -> memberService.isDuplicatedWithOtherMemberName(null, channelName))
            .isInstanceOf(IllegalArgumentException.class);
      }
    }
    ...
    class ContextNullEmptyNameArgument {
      ...
      void itTrowIllegalArgumentException(String channelName) {
        ...
        //then
        Assertions.assertThatThrownBy(
                () -> memberService.isDuplicatedWithOtherMemberName(validWorkspaceId, channelName))
            .isInstanceOf(IllegalArgumentException.class);
      }
    }
    ...
    class ContextValidArgument {
      ...
      void itReturnFalse() {
        ...
        final boolean expected =
            memberService.isDuplicatedWithOtherMemberName(validWorkspaceId, validChannelName);
