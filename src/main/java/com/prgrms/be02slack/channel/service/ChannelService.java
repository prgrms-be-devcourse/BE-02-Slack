...
public interface ChannelService {
  ...
  void invite(String workspaceId, String channelId, InviteRequest inviteRequest) throws
      MessagingException;

  AuthResponse participate(String workspaceId, String channelId, String token);
